 ...
 * В этом классе реализован паттерн Singleton
 */
class App
{
	...
	private function __construct() {} // Блокируем создание объектов через new App
	private function __clone() {} // Блокируем создание объектов через клонирование
	private function __wakeup() {} // Блокируем создание объектов через unserialize
}